...
};function n(){geocoder=new google.maps.Geocoder();this.geocode=function(r,v){r=unescape(encodeURIComponent(r));geocoder.geocode({address:r},function(y,x){if(x==google.maps.GeocoderStatus.OK){var w={};
...
var x=a("#"+c.formID+" #"+c.inputID).val();x=unescape(encodeURIComponent(x));if(x==""){alert("The input box was blank.");}else{var v=new n();var r=x;v.geocode(r,function(y){if(y!=null){s=y.latitude;
