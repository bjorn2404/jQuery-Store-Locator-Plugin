...
p=[];if(c.dataType==="kml"){E="xml";}else{E=c.dataType;}a.ajax({type:"GET",url:c.dataLocation+(c.dataType==="jsonp"?(c.dataLocation.match(/\?/)?"&":"?")+"callback=?":""),dataType:E,jsonpCallback:c.jsonpCallback,beforeSend:function(){if(c.callbackBeforeSend){c.callbackBeforeSend.call(this);
