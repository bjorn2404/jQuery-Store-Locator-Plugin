...
var ac=new google.maps.InfoWindow();if((p.length-1)<c.storeLimit-1){k=p.length-1;}else{k=c.storeLimit-1;}if(c.originMarker===true&&c.fullMapStart===false){var T=new google.maps.MarkerImage("http://chart.apis.google.com/chart?chst=d_map_pin_shadow",new google.maps.Size(40,37),new google.maps.Point(0,0),new google.maps.Point(12,35));
var af=new google.maps.LatLng(r,E);var V=new google.maps.Marker({position:af,map:ar,icon:"http://maps.google.com/mapfiles/ms/icons/"+c.originpinColor+"-dot.png",shadow:T,draggable:false});
...
function N(av,ay,ax,aC,aA){var aB=new google.maps.MarkerImage("http://chart.apis.google.com/chart?chst=d_map_pin_letter&chld="+aC+"|"+c.pinColor+"|"+c.pinTextColor,new google.maps.Size(21,34),new google.maps.Point(0,0),new google.maps.Point(10,34));
var az=new google.maps.MarkerImage("http://chart.apis.google.com/chart?chst=d_map_pin_shadow",new google.maps.Size(40,37),new google.maps.Point(0,0),new google.maps.Point(12,35));
...
}return aw;}function S(ay,ax){var aw=R(ay);var av=g(aw);if(ax==="left"){ac.setContent(av);ac.open(ay.get(c.mapDiv),ay);}else{google.maps.event.addListener(ay,"click",function(){ac.setContent(av);
ac.open(ay.get(c.mapDiv),ay);a("#"+c.listDiv+" li").removeClass("list-focus");markerId=ay.get("id");a("#"+c.listDiv+" li[data-markerid="+markerId+"]").addClass("list-focus");
