...
(function(a){a.fn.storeLocator=function(b){var c=a.extend({mapDiv:"map",listDiv:"list",formID:"user-location",zoomLevel:12,pinColor:"fe7569",pinTextColor:"000000",storeLimit:26,distanceAlert:60,xmlLocation:"locations.xml",listColor1:"ffffff",listColor2:"eeeeee",bounceMarker:true,slideMap:false,modalWindow:true},b);
...
if(s==""){alert("The input box was blank.");}var q=new j();var p=s;q.geocode(p,function(t){if(t!=null){n=t.latitude;o=t.longitude;d(n,o);}else{alert("ERROR! Unable to geocode address");
